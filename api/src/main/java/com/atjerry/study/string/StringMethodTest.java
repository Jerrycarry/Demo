...
public class StringMethodTest {
    ...
    public void test2(){
        ...
        //String ----> 基本数据类型:调用包装类parseXxx(String str)
        String s3 = "123";
    ...
    //String与byte[]之间的转换
    /**
     * 在utf-8字符集中,一个汉字占三个字节,一个字母占一个字节。
     * 在GBK字符集中,一个汉字占两个字节,一个字母占一个字节。
     *
    ...
    public void test4() throws UnsupportedEncodingException {
        ...
        //String ---->byte[]:调用String的
        byte[] arr = str.getBytes();
        for (int i = 0; i < arr.length; i++) {//使用默认字符集：UTF-8
